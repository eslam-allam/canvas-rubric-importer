...
public record Assignment(
        ...
        Boolean turnitinEnabled,
        // VeriCite enabled
        @JsonProperty("vericite_enabled")
        Boolean vericiteEnabled,
        // Turnitin settings
        ...
        Boolean gradeGroupStudentsIndividually,
        ...
        Boolean onlyVisibleToOverrides,
        ...
        Boolean useRubricForGrading,
        // basic attributes of the rubric
        @JsonProperty("rubric_settings")
        RubricModels.Settings rubricSettings,
        ...
        Boolean postManually,
        // score statistics
        @JsonProperty("score_statistics")
        ScoreStatistic scoreStatistics,
        ...
        @JsonProperty("original_lti_resource_link_id")
        Long originalLtiResourceLinkId,
