...
public final class RubricModels {
    ...
    public static final record Rating(String id, String description, Double points, 
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final record Criteria(Integer points, String id, 
        @JsonProperty("learing_outcome_id")
        ...
        Boolean criterionUseRange,
        @JsonProperty("ignore_for_scoring")
        Boolean ignoreForScoring,
    ...
    public static final record Created(
        Integer rubric, 
        @JsonProperty("rubric_association")
        Integer rubricAssociation
    ){}
