...
public record Course(
        ...
        @JsonProperty("sis_import_id") Long sisImportId,
        ...
        @JsonProperty("root_account_id") Long rootAccountId,

        // the enrollment term associated with the course
        @JsonProperty("enrollment_term_id") Long enrollmentTermId,

        // the grading standard associated with the course
        @JsonProperty("grading_standard_id") Long gradingStandardId,

        // the grade_passback_setting set on the course
        @JsonProperty("grade_passback_setting") String gradePassbackSetting,
        ...
        @JsonProperty("default_view") String defaultView,

        // optional: user-generated HTML for the course syllabus
        @JsonProperty("syllabus_body") String syllabusBody,
        ...
        @JsonProperty("course_progress") CourseProgress courseProgress,

        // weight final grade based on assignment group percentages
        @JsonProperty("apply_assignment_group_weights") Boolean applyAssignmentGroupWeights,
        @JsonProperty("is_public") Boolean isPublic,
        @JsonProperty("is_public_to_auth_users") Boolean isPublicToAuthUsers,
        @JsonProperty("public_syllabus") Boolean publicSyllabus,
        @JsonProperty("public_syllabus_to_auth") Boolean publicSyllabusToAuth,

        // optional: the public description of the course
        @JsonProperty("public_description") String publicDescription,
        @JsonProperty("storage_quota_mb") Integer storageQuotaMb,
        @JsonProperty("storage_quota_used_mb") Integer storageQuotaUsedMb,
        @JsonProperty("hide_final_grades") Boolean hideFinalGrades,
        String license,
        @JsonProperty("allow_student_assignment_edits") Boolean allowStudentAssignmentEdits,
        @JsonProperty("allow_wiki_comments") Boolean allowWikiComments,
